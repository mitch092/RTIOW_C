...
vec3 reals_to_vec3(const real x, const real y, const real z) {
  vec3 v = {.x = x, .y = y, .z = z};
  return v;
}
...
vec3 vec3_origin(void) { return reals_to_vec3(0, 0, 0); };

vec3 vec3_mult_scalar(const vec3 v, const real r) { return reals_to_vec3(v.x * r, v.y * r, v.z * r); }
...
vec3 vec3_cross_vec3(const vec3 v1, const vec3 v2) {
  return reals_to_vec3(v1.y * v2.z - v1.z * v2.y, v1.z * v2.x - v1.x * v2.z, v1.x * v2.y - v1.y * v2.x);
}

vec3 vec3_negate(const vec3 v) { return vec3_mult_scalar(v, -1); }

vec3 vec3_add_vec3(const vec3 v1, const vec3 v2) { return reals_to_vec3(v1.x + v2.x, v1.y + v2.y, v1.z + v2.z); }

vec3 vec3_sub_vec3(const vec3 v1, const vec3 v2) { return reals_to_vec3(v1.x - v2.x, v1.y - v2.y, v1.z - v2.z); }

vec3 vec3_mult_vec3(const vec3 v1, const vec3 v2) { return reals_to_vec3(v1.x * v2.x, v1.y * v2.y, v1.z * v2.z); }
